...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../soc1.sopcinfo
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x63160
SOPC_SYSID_FLAG += --sidp=0x63160
ELF_PATCH_FLAG  += --sidp 0x63160

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1671655434
SOPC_SYSID_FLAG += --timestamp=1671655434
ELF_PATCH_FLAG  += --timestamp 1671655434
